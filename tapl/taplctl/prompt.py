...
def custom_fields_guidance() -> str:
    return (
        ...
        "user choices, constraints, and decision rationale. Before writing a patch, inspect the record's existing "
        "`custom_fields` with `taplctl status` or `taplctl item show`. Keep at most one field for each fact, decision, "
