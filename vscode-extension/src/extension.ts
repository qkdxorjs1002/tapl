...
function renderOverview(status: TaplStatus, searchQuery = ''): string {
...
function renderWorkflowTabPanel(tab: WorkflowTab): string {
  return `
    <section
...
async function safeArchives(): Promise<{ ok: true; value: TaplArchive[] } | { ok: false; error: string }> {
